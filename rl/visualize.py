...
plt.scatter(x, episodes[0], color='r', label='Trial 1 (30 episodes)')
plt.scatter(x, episodes[1], color='b', label='Trial 2 (30 episodes)')
plt.scatter(x, episodes[2], color='g', label='Trial 3 (30 episodes)')
plt.scatter(x, episodes[3], color='y', label='Trial 4 (30 episodes)')
plt.scatter(x, episodes[4], color='m', label='Trial 5 (30 episodes)')
plt.ylabel("Score (stopped at 20)")
plt.xlabel("Episodes")
