...
PIPEHEIGHT = 320
PIPEGAPSIZE  = 100
Y_MAX_LPIPE = 0.60 * BASEY
Y_MIN_LPIPE = 0.40 * BASEY
if PIPEGAPSIZE > (.60 * BASEY):
    Y_MIN_LPIPE = BASEY - (BASEY - PIPEGAPSIZE) / 2
    Y_MAX_LPIPE = Y_MIN_LPIPE + 1
